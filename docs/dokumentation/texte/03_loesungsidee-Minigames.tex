...
\begin{table}[h!]
    ...
    \label{tab:wahrheitswerttabellen01}
\end{table}

Diese Tabellen werden den Spielenden, aufgrund der ansprechenderen Gestaltung, in Form einer Abbildung präsentiert.
...
In der Abbildung \ref{tab:wahrheitswerttabellen01} ist dies beispielhaft anhand der ersten Wahrheitswerttabelle ($G = \land$) zu erkennen.
...
\begin{table}[h!]
    ...
    \end{minipage}
    \caption{Wahrheitswerttabellen für Level 1 des Informatik-Minispiels}
    \label{tab:wahrheitswerttabellen02}
\end{table}
...
Endgültige Liste einzigartiger Y-Vektoren mit Kombinationen:
