...
Durch das Klicken mit der linken Maustaste auf den Simulate-Button, wird die Simulation (das Bewegen des Balls) gestartet.

\subsubsection{Biologie}
Beim Minispiel der Fachschaft Chemie kann durch das Klicken mit der linken Maustaste auf ein Label, dieses ausgewählt werden, durch ein erneutes Klicken wird die Auswahl aufgehoben.
