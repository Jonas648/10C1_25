...
Trotz dieser Umstände wurde aber keineswegs auf Test verzichtet, wie in den folgenden Abschnitten deutlich wird, jedoch sind konkrete, dokumentierte und dadurch wiederholbare Tests wegen bereits genanntem nicht vorhanden.
